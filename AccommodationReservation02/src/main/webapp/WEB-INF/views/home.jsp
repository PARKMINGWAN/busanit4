...
<html>
	<head>
   <title>요기어때 &mdash; -전국최저가 예약사이트-</title>
...
<body>
   ...
   <div class="hero">
      ...
      <div class="hero-slide">
         <div class="img overlay" style="background-image: url('/resources/images/img_88.jpg')"></div>
         <div class="img overlay" style="background-image: url('/resources/images/img_11.jpg')"></div>
         <div class="img overlay" style="background-image: url('/resources/images/img_22.jpg')"></div>
         <div class="img overlay" style="background-image: url('/resources/images/img_33.jpg')"></div>
         <div class="img overlay" style="background-image: url('/resources/images/img_99.jpg')"></div>
      </div>
      ...
      <div class="container">
         ...
         <div class="row justify-content-center align-items-center">
            <div class="col-lg-10 text-center">
               <h1 class="heading" data-aos="fade-up">여행지를 검색해보세요!</h1>
               <form action="#" class="form-search d-flex align-items-stretch mb-3" data-aos="fade-up" data-aos-delay="200">
                  <input type="text" class="form-control px-4" placeholder="지역, 숙소이름, 주소를 검색해주세요">
                  
                   <div class="container px-1 px-sm-10 mx-auto">
              
                     <div class="input-group input-daterange">
                            <input type="text" name="daterange"  class="form-control px-4" value="01/01/2018 - 01/15/2018" readonly />
                          </div>
                  </div>
		...
		<div class="section">
			<div class="container">
				<div class="row mb-5 align-items-center">
					<div class="col-lg-6">
						<h2 class="font-weight-bold text-primary heading">인기 숙소</h2>
					</div>
